...
plot(u;legend=false)						    # Requires Gadfly or PyPlot
...
plot(real(uFourier);legend=false)						    # Requires Gadfly or PyPlot
...
plot(f/sum(f);legend=false)                           # Requires Gadfly or PyPlot
