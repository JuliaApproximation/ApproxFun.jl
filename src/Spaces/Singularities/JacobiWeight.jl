...
JacobiWeight(a::Number,b::Number,d::Vector)=JacobiWeight(float64(a),float64(b),Interval(d))
...
spaceconversion{S<:JacobiWeight,n}(f::Vector,sp::JacobiWeight,S2::DropSpace{S,n,Float64,Interval})=error("Implement")
